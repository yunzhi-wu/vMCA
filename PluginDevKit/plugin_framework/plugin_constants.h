...
#define DLL_API_VERSION_TXT "DLL_API_VERSION_V1"
#define DLL_API_VERSION_V1  11                      // Current version of the dll plugin framework. Checked by LogScrutinizer such that it has the same version

// DLL_API_VERSION_V1 = 7 : v1.2.B4 Pre30
// DLL_API_VERSION_V1 = 8 : v1.2.B4 Pre33
// DLL_API_VERSION_V1 = 9 : v1.2.B4 Pre35

#define PLUGIN_INFO_V1_NAME_MAX_SIZE      256
#define PLUGIN_INFO_V1_VERSION_MAX_SIZE   256
#define PLUGIN_INFO_V1_AUTHOR_MAX_SIZE    512
#define PLUGIN_INFO_V1_HELP_URL_MAX_SIZE  1280
...
#define SUPPORTED_FEATURE_MATCH_STRINGS                     (1 << 8)  // 256    WARNING: LogScrutinizer will only call pvPlotRow if at least one of the added match strings have a match with the text row
