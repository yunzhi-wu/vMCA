...
void CList_LSZ::InsertAfter(CListObject* afterListObject_p, CListObject* listObject_p)
{
  ...
  if (afterListObject_p->m_next_p != NULL)
  {
...
void CList_LSZ::InsertBefore(CListObject* beforeListObject_p, CListObject* listObject_p)
{
  ...
  if (beforeListObject_p->m_previous_p != NULL)
  {
  ...
  {
    listObject_p->m_previous_p                  = NULL;
  }
...
void CList_LSZ::DeleteAll(void)
{
  ...
  CListObject* nextlistObject_p   = NULL;
...
bool CGraph::AddBox(double x1, float y1, double x2, float y2, unsigned int row)
{
  GraphicalObject_Box_t* newBox_p = (GraphicalObject_Box_t*)m_byteStreamManager_p->AddBytes(sizeof(GraphicalObject_Box_t));
...
void CGraph::SetLinePattern(GraphLinePattern_t pattern)
{
...
lifeLine_h CSequenceDiagram::AddLifeLine(float y1, float y2, char* label_p, unsigned char labelLength, int colorRGB)
{

  // 1. Add the life line box
  // 2. Add the life line line

  unsigned int totalObjectSize = sizeof(GraphicalObject_LifeLine_Box_t) + labelLength;

  // Add the lifeline box in the m_decorator member
  GraphicalObject_LifeLine_Box_t* newLifeLine_Box_p = (GraphicalObject_LifeLine_Box_t*)  m_decorator_p->m_byteStreamManager_p->AddBytes(totalObjectSize);

  if (newLifeLine_Box_p == NULL)
  {
    ErrorHook("CSequenceDiagram::AddLifeLine Box failed, out of memory\n");
    return (lifeLine_h)NULL;
  }
  ...
  // Add the lifeline box in the m_decorator member
  GraphicalObject_LifeLine_Line_t* newLifeLine_Line_p = (GraphicalObject_LifeLine_Line_t*)  m_decorator_p->m_byteStreamManager_p->AddBytes(totalObjectSize);

  if (newLifeLine_Line_p == NULL)
  {
...
bool CSequenceDiagram::AddMessage(lifeLine_h lifeLine1, double x, lifeLine_h lifeLine2, unsigned int row, unsigned int labelIndex, int colorRGB, bool synched, bool startsExecution)
{
  ...
  AddLine(x, lifeLine1_p->y_center, x, lifeLine2_p->y_center, row, labelIndex, colorRGB, 0.5f, lineEnds);
...
bool CSequenceDiagram::AddMessage(lifeLine_h lifeLine1, double x, lifeLine_h lifeLine2, unsigned int row, char* label_p, unsigned char labelLength, int colorRGB, bool synched, bool startsExecution)
{
  GraphicalObject_LifeLine_Box_t* lifeLine1_p = (GraphicalObject_LifeLine_Box_t*)lifeLine1;
  GraphicalObject_LifeLine_Box_t* lifeLine2_p = (GraphicalObject_LifeLine_Box_t*)lifeLine2;
...
bool CSequenceDiagram::AddReturnMessage(lifeLine_h lifeLine1, double x, lifeLine_h lifeLine2, unsigned int row, unsigned int labelIndex, int colorRGB, bool fromExecution, bool startsExecution)
{
  GraphicalObject_LifeLine_Box_t* lifeLine1_p = (GraphicalObject_LifeLine_Box_t*)lifeLine1;
  GraphicalObject_LifeLine_Box_t* lifeLine2_p = (GraphicalObject_LifeLine_Box_t*)lifeLine2;
...
bool CSequenceDiagram::AddReturnMessage(lifeLine_h lifeLine1, double x, lifeLine_h lifeLine2, unsigned int row, char* label_p, unsigned char labelLength, int colorRGB, bool fromExecution, bool startsExecution)
{
  GraphicalObject_LifeLine_Box_t* lifeLine1_p = (GraphicalObject_LifeLine_Box_t*)lifeLine1;
  GraphicalObject_LifeLine_Box_t* lifeLine2_p = (GraphicalObject_LifeLine_Box_t*)lifeLine2;
...
bool CSequenceDiagram::AddEvent(lifeLine_h lifeLine, double x, unsigned int row, unsigned int labelIndex, int colorRGB, bool startsExecution)
{
...
bool CSequenceDiagram::AddEvent(lifeLine_h lifeLine, double x, unsigned int row, char* label_p, unsigned char labelLength, int colorRGB, bool startsExecution)
{
  GraphicalObject_LifeLine_Box_t* lifeLine_p = (GraphicalObject_LifeLine_Box_t*)lifeLine;
...
bool CSequenceDiagram::AddExecution(lifeLine_h lifeLine, double x1, double x2, unsigned int row, unsigned int labelIndex, int colorRGB)
{
  GraphicalObject_LifeLine_Box_t* lifeLine_p = (GraphicalObject_LifeLine_Box_t*)lifeLine;

  AddBox(x1, lifeLine_p->y_execBottom, x2, lifeLine_p->y_execTop, row, labelIndex, colorRGB);
